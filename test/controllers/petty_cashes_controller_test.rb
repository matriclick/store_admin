...
class PettyCashesControllerTest < ActionController::TestCase
  ...
  test "should create petty_cash" do
    assert_difference('PettyCash.count') do
      post :create, petty_cash: { close_amount: @petty_cash.close_amount, close_date: @petty_cash.close_date, supplier_account_id: @petty_cash.supplier_account_id, user_id: @petty_cash.user_id }
    end
  ...
  test "should update petty_cash" do
    patch :update, id: @petty_cash, petty_cash: { close_amount: @petty_cash.close_amount, close_date: @petty_cash.close_date, supplier_account_id: @petty_cash.supplier_account_id, user_id: @petty_cash.user_id }
    assert_redirected_to petty_cash_path(assigns(:petty_cash))
  end
